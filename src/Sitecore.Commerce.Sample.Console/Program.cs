...
namespace Sitecore.Commerce.Sample.Console
{
    public class Program
    {
        ...
        public static string OpsServiceUri = "https://localhost:5115/CommerceOps/";
        public static string ShopsServiceUri = "https://localhost:5105/api/";
        public static string MinionsServiceUri = "https://localhost:5110/CommerceOps/";
        public static string AuthoringServiceUri = "https://localhost:5100/api/";
        public static string SitecoreIdServerUri = "https://xp101.scidentityserver.dev.local/";
        ...
        private static readonly bool ShouldRunGenericSearchScenarios = true;
        ...
        static async Task Main(string[] args)
        {
            try
            {
                ...
                if (ShouldRunGenericSearchScenarios)
                {
                    await GenericSearch.RunScenarios();
                }
